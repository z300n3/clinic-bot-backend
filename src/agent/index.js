...
# قواعد الحجز
- اسم المريض يجب أن يكون ثنائي على الأقل (اسم + اسم الأب أو العائلة). إذا أعطى المريض اسم أحادي فقط، اطلب منه الاسم الكامل: "أحتاج الاسم الثنائي على الأقل (مثال: علي حسن)".
