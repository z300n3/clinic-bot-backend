...

{
  ...
  "faq_topic": "hours|absence|general_faq أو null"
}
...
- faq_topic: hours إذا سأل عن أوقات الدوام بشكل عام، absence إذا سأل عن غياب الدكتور أو إجازته أو البديل، general_faq إذا سأل أي سؤال عام آخر عن خدمات العيادة، العنوان، الأسعار، أو أي معلومة.
